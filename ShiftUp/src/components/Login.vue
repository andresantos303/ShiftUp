  ...
  <div class="flex flex-col md:flex-row h-screen">
    ...
    <div class="w-full md:w-1/2 flex mt-12 md:mt-0 flex-col justify-center items-center px-6 md:px-12">
      <div class="max-w-xl mx-auto">
        ...
        <!-- Btn Login -->
        <div class="mb-4">
          <Button :label="'Log in'" :to="''" bgColor="bg-custom-gradient" textColor="text-white" textSize="text-lg"
            additionalClasses="w-full py-3" @click="handleLogin" />
        </div>
    ...
    <div class="hidden md:block w-1/2 bg-gray-100">
      <img src="/public/images/loginImage.png" alt="Login Image" class="h-full w-full object-cover" />
    </div>
  </div>
</template>
