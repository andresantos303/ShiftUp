      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center justify-start">
            ...
            <a :href="`/participante/${id}/profile`" class="flex ms-2 md:me-24">
          ...
          <div class="flex items-center">
            <div class="flex items-center ms-3 relative">
              <img class="w-8 h-8 rounded-full cursor-pointer"
                :src="user.photo ? user.photo : '/images/profile-icon.png'" alt="User photo" @click="toggleDropdown" />
              <!-- Dropdown Menu -->
              <div v-if="dropdownOpen"
                class="absolute right-0 top-full mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg">
                <ul class="py-2">
                  <li>
                    <button @click="profile" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 w-full text-left">
                      Profile
                    </button>
                  </li>
                  <li>
    ...
    <aside :class="{ '-translate-x-full': !sidebarOpen, 'translate-x-0': sidebarOpen }"
      ...
      <div class="h-full px-3 pb-4 overflow-y-auto">
        <ul class="space-y-2 font-medium">
          <li>
            <RouterLink v-if="user.role !== 'voluntary'" :to="`/participante/${id}/events`"
